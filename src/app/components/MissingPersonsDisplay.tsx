...
const MissingPersonsDisplay: React.FC<MissingPersonsProps> = ({
  ...
  <>
    ...
    <div className="mt-2 grid gap-4 text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-2 lg:text-left">
      {tweets.map((tweet) => (
        <div
          key={tweet.tweetId}
          className="relative h-96 w-4/5 m-auto overflow-hidden"
        >
          {" "}
